...
async function hasFeatureFlag(featureFlag, options) {
    if (featureFlag === 'iacIntegratedExperience' &&
        config_1.default.API.includes('snykgov')) {
        return true;
    }
    ...
    async test(paths, options) {
        ...
        try {
            ...
            let readableResult = output_format_1.getCodeDisplayedOutput({
                ...
                meta,
                prefix,
                shouldFilterIgnored: (_d = options['report']) !== null && _d !== void 0 ? _d : false,
            });
            if (numOfIssues > 0 && options['no-markdown']) {
                (_f = (_e = sarifTypedResult.runs) === null || _e === void 0 ? void 0 : _e[0].results) === null || _f === void 0 ? void 0 : _f.forEach(({ message }) => {
